...
# Function to display the bilingual Master Strategy
def display_bilingual_result():
    # --- SECTION 1: English Result ---
    st.markdown("### 🇬🇧 Master Strategy (English)")
    st.markdown("""
    **🎯 Eligibility & Prerequisites**
    * **ITR-1:** Resident Individual with income up to ₹50L (Salary/House).
    * **ITR-4:** Presumptive Business Income (Non-resident or resident with presumptive business income).
    * **80C:** Max ₹1.5L deduction for Resident Individuals.

    **📄 Documents / Requirements (Retain, do NOT upload)**
    * Form 16 (Employer), Form 26AS (Tax Credit), AIS/TIS (Transaction Summary).

    **💰 Costs & Financials**
    * **Filing:** Free. | **Late Fee:** ₹1,000 or ₹5,000 (Sec 234F). | **TDS Refund:** Processed automatically.

    **👣 Step-by-Step Action Plan**
    1. **Login:** Visit [Income Tax Portal](https://www.incometax.gov.in/) using PAN.
    2. **Select ITR-1/4:** Choose based on your income type.
    3. **Fill Details:** Enter personal info and income sources.
    4. **Claim Deductions:** Enter Section 80C amounts.
    5. **Verify & Submit:** E-verify via Aadhaar OTP.

    **⏳ Timeline**
    * **Due Date:** 31st July (Non-audit). | **Refund:** 20-45 days.

    **⚠️ Official Disclaimer**
    * Tax liability varies by individual. Consult a CA for complex filings.
    """)

    st.divider() # Visual separator

    # --- SECTION 2: Hindi Result ---
    st.markdown("### 🇮🇳 मास्टर रणनीति (हिंदी)")
    st.markdown("""
    **🎯 पात्रता और पूर्वापेक्षाएँ**
    * **ITR-1:** ₹50 लाख तक की आय (वेतन/घर) वाले निवासी व्यक्ति।
    * **ITR-4:** अनुमानित व्यावसायिक आय (गैर-निवासी या अनुमानित व्यवसाय आय वाले निवासी)।
    * **80C:** निवासी व्यक्तियों के लिए अधिकतम ₹1.5 लाख की कटौती।

    **📄 दस्तावेज / आवश्यकताएं (पास रखें, अपलोड न करें)**
    * फॉर्म 16 (नियोक्ता), फॉर्म 26AS (टैक्स क्रेडिट), AIS/TIS (लेनदेन सारांश)।

    **💰 लागत और वित्तीय जानकारी**
    * **फाइलिंग:** मुफ्त। | **विलंब शुल्क:** ₹1,000 या ₹5,000 (धारा 234F)। | **TDS रिफंड:** स्वचालित रूप से प्रोसेस होता है।

    **👣 फाइलिंग के लिए चरण-दर-चरण योजना**
    1. **लॉगिन:** अपना PAN उपयोग करके [आयकर पोर्टल](https://www.incometax.gov.in/) पर जाएं।
    2. **ITR-1/4 चुनें:** अपनी आय के प्रकार के आधार पर फॉर्म चुनें।
    3. **विवरण भरें:** व्यक्तिगत जानकारी और आय के स्रोत दर्ज करें।
    4. **कटौती का दावा करें:** धारा 80C के तहत निवेश की जानकारी भरें।
    5. **सत्यापित करें और जमा करें:** आधार OTP के माध्यम से ई-वेरिफाई (E-verify) करें।

    **⏳ समय सीमा**
    * **अंतिम तिथि:** 31 जुलाई (बिना ऑडिट के)। | **रिफंड:** 20-45 दिन।

    **⚠️ आधिकारिक अस्वीकरण**
    * कर देयता व्यक्ति के अनुसार अलग होती है। जटिल फाइलिंग के लिए CA से सलाह लें।
    """)
